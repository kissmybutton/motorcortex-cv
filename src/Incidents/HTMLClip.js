...
import AnimeTitlesDefinition from "@donkeyclip/motorcortex-animetitles";
...
const Animetitles = loadPlugin(AnimeTitlesDefinition)
  ...
  get html(){
    return `
      <div class="wrapper">
        ...
        <div class="hello-wrapper">
            ...
            <div class="hello-my-name secondery-text ft">${splitWords("My name is","myname")}</div>
            <div class="dev-name secondery-text ft"><div class="full-name">${this.attrs.firstName} ${this.attrs.lastName}</div></div>
        </div>
        ...
        <div class="lable-cover2"></div>
        <div class="lable-cover"></div>
    ...
    get css(){
      ...
      const calcScale= ({width,height})=>{
        return Math.max(512 / width, 720 / height);
      }
        ...
        return `
          ...
          .video-container{
            ...
            align-items: center;
            overflow: hidden;
            transform: scale(${calcScale({...this.attrs.videoSize})});
    ...
    buildTree(){
      const educationOutTime = this.attrs.educationTime + 3000
      const skillTimingOut = educationOutTime + this.attrs.skillTiming
      const softSkillTimingOut= skillTimingOut + this.attrs.softSkillTiming
      ...
      const engagement = { 
        ...
        "dataSets": [
          {
            "title": this.attrs.skillOverview.dataSetsTitles[0],
            "color": "#ffa758"
          },
          {
            "title": this.attrs.skillOverview.dataSetsTitles[1],
            "color": "#00a4a7"
          },
          {
            "title": this.attrs.skillOverview.dataSetsTitles[2],
            "color": "#788cef"
          },{
            "title": this.attrs.skillOverview.dataSetsTitles[3],
            "color": "#fe8282"
          }
        ],
    ...
    const devText = new Anime.Anime(
      ...
      const educationTextMove = new Anime.Anime(
        ...
        {
          duration: 10000,
          repeats: Math.floor(this.attrs.educationTime/10000),
          selector: ".title-education-wrapper",
        }
      );
      ...
      const barChart = new Graph.BarChartSimple(
        {
          ...
          timings: {
            intro: 1000,
            static: this.attrs.softSkillTiming,
            outro: 1000,
          },
          palette: {
            background: "#fff0",
      ...
      const lableCoverOpacity = new Anime.Anime(
        {
          animatedAttrs: {
            opacity:1
          },
        ...
        {
          duration: 1,
          selector: ".lable-cover,.lable-cover2",
          easing: "easeOutQuart"
        }
      );

      
      const lableCoverOpacityZero = new Anime.Anime(
        {
          animatedAttrs: {
            opacity:0
          },
      ...
      const barCharLablecontainerOut = new Anime.Anime(
        ...
        {
          duration: 500,
          selector: ".bar-char-lable-container,.bar-char-lable-wrapper,.bar-chart-bg",
          easing: "easeOutQuart",
          delay: `@stagger(0, 500)`
        }
      );
      ...
      this.addIncident(lableCoverOpacity,educationOutTime);
      ...
      this.addIncident(lableCoverOpacityZero,skillTimingOut+600);
